...
function AccommodationBulkImportModal({ open, onClose, onSuccess }) {
  ...
  const handleImport = async () => {
    ...
    setLoading(true);
    try {
      const response = await accommodationsAPI.bulkImport(file);
    ...
    <Dialog open={open} onClose={handleClose} maxWidth="md" fullWidth>
      <DialogTitle>
        <Typography variant="h5" sx={{ fontWeight: 600 }}>
          Tömeges szálláshely importálás
        </Typography>
      </DialogTitle>
        ...
        {!file && (
          ...
          >
            ...
            <Typography variant="caption" color="text.secondary" sx={{ mt: 1, display: 'block' }}>
              Oszlopok: Név, Cím, Típus, Kapacitás, Státusz, Havi bérleti díj, Megjegyzés
            </Typography>
          </Box>
        )}
        ...
        {result && (
          <Box sx={{ mt: 2 }}>
            <Alert severity="success" sx={{ mb: 2 }}>
              {result.imported} szálláshely sikeresen importálva
            </Alert>
...
export default AccommodationBulkImportModal;
