...
export const billingAPI = {
  ...
  listProfiles: async () => (await api.get('/billing/profiles')).data,
  upsertProfile: async (contractorId, body) => (await api.put(`/billing/profiles/${contractorId}`, body)).data,
  rateCoverage: async (month) => (await api.get('/billing/rate-coverage', { params: { month } })).data,
